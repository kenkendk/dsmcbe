...
int dsmcbe_new_cspChannelWriteRequest_multiple(struct dsmcbe_cspChannelWriteRequest** result, unsigned int requestId, unsigned int mode, GUID* channels, size_t channelcount, size_t size, void* data, unsigned int onSPE, struct dsmcbe_QueueableItemStruct* transferManager);
int dsmcbe_new_cspChannelWriteRequest_single(struct dsmcbe_cspChannelWriteRequest** result, GUID channelid, unsigned int requestId, void* data, size_t size, unsigned int onSPE, struct dsmcbe_QueueableItemStruct* transferManager);
